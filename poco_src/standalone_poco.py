...
#   https://github.com/poyo-brain/poyo
#
# Original paper:
#   Azabou et al. (2024). "A Unified, Scalable Framework for Neural Population Decoding."
#   NeurIPS 2024. https://arxiv.org/abs/2310.16046
#
# Modifications made in this project:
#   - Extracted into a single self-contained file (no package install required)
...
class RotaryCrossAttention(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.using_memory_efficient_attn = False
